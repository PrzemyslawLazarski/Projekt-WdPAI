...
start_btn.onclick = async () => {
    // Pobieramy pytania i odpowiedzi z bazy danych
    const quizId = 1; // TODO Tutaj podaj odpowiednie ID quizu
...
async function getQuizQuestions(quizId) {
    const response = await fetch(`getQuizQuestions.php?quizId=${quizId}`);
